...
Esta definição leva a quaisquer conjuntos diferentes sendo consistentes do que a definição na p.~\pageref{def.consistencyLS}? Explique sua resposta.
