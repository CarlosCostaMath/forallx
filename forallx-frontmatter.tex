...
\vspace*{60pt} % Reduzido para evitar problemas de overflow

\begin{flushright}
{\sffamily\bfseries\fontsize{28}{34}\selectfont
forall {\rmfamily\itshape\fontsize{34}{40}\selectfont x}}
...
\href{https://www.fecundity.com/logic/}{fecundity.com/logic}, versão 1.4\\
...
Esta cópia de \forall x\ (versão em português) foi \textbf{atualizada em 13 de novembro de 2025}. A versão mais recente da obra original está disponível em \url{http://www.fecundity.com/logic}
}
