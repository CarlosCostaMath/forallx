...
\multicolumn{2}{c}{\textsc{Conectivos Sentenciais} (capítulo \ref{ch.LS})}\\ \\
...
\\
\multicolumn{2}{c}{\label{SymbolizingPredicates}\textsc{Predicados} (capítulo \ref{ch.LQ})}\\ \\
...
\textsc{Troca do Bicondicional} (\eiff)\\
