...
\end{tabular}
\end{center}
Agora considere a subsentença $H\eand I$. Ela é uma conjunção \script{A}\eand\script{B} em que $H$ faz o papel de \script{A} e $I$ faz o papel de \script{B}. $H$ e $I$ são ambas verdadeiras na primeira linha. Como uma conjunção é verdadeira quando ambos os conjuntos são verdadeiros, escrevemos 1 sob o símbolo de conjunção. Continuamos para as outras três linhas e obtemos:
\begin{center}
\begin{tabular}{c|c|@{\TTon}*{5}{c}@{\TToff}}
$H$&$I$&$(H$&\eand&$I)$&\eif&$H$\\
\hline
